...
/*Sets base directory*/
/*********************/
global project "/Users/shreyachandra/Dropbox/Berkeley/Spring 2022/Econ 270B - Dev/Problem Sets/PS2/Acemoglu_etal_2020/replication_files_ddcg/replication_ps2"  /* Set base directory                         */
...
* 
* This program generates estimates of 25 year effect,
* long run effect, persistence of GDP. Short run effect,
* and estimates of lag(1-4) are obtained from the main regression code.
*
...
*
* This program generates HHK estimates.
*
...
* Main estimate (instrument = 1 period lag) - col (1)
...
* Instrument = 4 period lags - col (2)
...
* Controlling for initial GDP - col (3)
...
* Controlling for regional trends - col (5)
...
* Controlling for trade + regional GDP - col (6)
...
* Controlling for regional Unrest, GDP and trade - col (7)
...
* Controlling for spatial lags in GDP - col (8)
...
* Allowing GDP shocks to be spatially correlated - col (9)
...
**********************************************************************
* ADDING ROBUSTNESS - ARE EFFECTS DRIVEN BY RICHER/WESTERN COUNTRIES?


levelsof region, loc(reg)
foreach r of local reg {

	qui xtivreg2 y l(1/4).y (dem=l.instrument) yy* if region != "`r'", fe cluster(wbcode2) r  partial(yy*)
	di "`r' = "  _b[dem]
